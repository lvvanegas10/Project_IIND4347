...
# y la correlaci贸n entre las variables independientes:
...
#usando toda la informaci贸n de las tres variables.
...
# que tengo?:
names(mapCol_idh)
# nombre de la variables que usar茅:
...
# a帽ado columna con nombre de regiones
